...
(defun cl-night ()
  ...
  (ignore-errors  (color-theme-install
                   '(color-theme-da-normal
                     ...
                     (default ((t (:stipple nil :background "#272727" :foreground "honeydew3" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :foundry "outline" :family "Consolas"))))
                     (bbdb-company ((t (nil))))
                     ...
                     (org-column ((t (:background "black" :foreground "gray80" :strike-through
                                                  ...
                                                  normal :height 98 :family "Consolas"))))
                     ...
                     (tooltip ((t (:family "Consolas" :background "systeminfowindow" :foreground "systeminfotext"))))
...
(defun cl-dawn ()
  ...
  (ignore-errors  (color-theme-install
                   '(color-theme-da-matlab
                     ...
                     (mouse-color . "black"))
					 (default ((t (:stipple nil :background "light goldenrod yellow" :foreground "black" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :foundry "outline" :family "Consolas"))))
                     (bm-persistent-face ((t (:foreground "white" :background "darkblue" :weight bold))))
                     (bm-fringe-persistent-face ((t (:foreground "white" :background "darkblue" :weight bold))))
                     (bold ((t (:bold t :weight bold))))
                     (bold-italic ((t (:bold t :italic t :slant italic :weight bold))))
                     ...
                     (custom-documentation ((t (nil))))
                     (custom-face-tag ((t (:bold t :family "Consolas" :weight bold :height 1.2))))
                     (custom-group-tag ((t (:bold t :foreground "blue1" :weight bold :height 1.2))))
                     (custom-group-tag-1 ((t (:bold t :family "Consolas" :foreground "red1" :weight bold :height 1.2))))
                     ...
                     (custom-themed ((t (:background "blue1" :foreground "white"))))
                     (custom-variable-button ((t (:bold t :underline t :weight bold))))
                     (custom-variable-tag ((t (:bold t :family "Consolas" :foreground "blue1" :weight bold :height 1.2))))
                     ...
                     (tabbar-button-face ((t (:background "gray72" :family "Consolas" :foreground "dark red" :box (:line-width 2 :color "white" :style released-button) :height 0.8))))
                     (tabbar-default-face ((t (:family "Consolas" :background "gray72" :foreground "gray60" :height 0.8))))
                     (tabbar-selected-face ((t (:background "gray72" :family "Consolas" :foreground "blue" :box (:line-width 2 :color "white" :style released-button) :height 0.8))))
                     (tabbar-separator-face ((t (:foreground "gray60" :background "gray72" :family "Consolas" :height 0.16000000000000003))))
                     (tabbar-unselected-face ((t (:foreground "gray60" :background "gray72" :family "Consolas" :box (:line-width 2 :color "white" :style pressed-button) :height 0.8))))
