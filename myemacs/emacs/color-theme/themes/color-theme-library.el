  ...
  (let ((color-theme-is-cumulative t))
    (color-theme-install
     '(color-theme-subtle-hacker
       ...
       (font-lock-variable-name-face ((t (:italic t :foreground "Aquamarine"))))
       ...
       (gnus-group-mail-3-face ((t (:foreground "tomato"))))
       ...
       (gnus-group-news-1-face ((t (:foreground "green yellow"))))
       (gnus-group-news-2-empty-face ((t (:foreground "dark orange"))))
       (gnus-group-news-2-face ((t (:foreground "dark orange"))))
       (gnus-group-news-3-empty-face ((t (:foreground "tomato"))))
       (gnus-group-news-3-face ((t (:foreground "tomato"))))
       (gnus-group-news-low-empty-face ((t (:foreground "yellow green"))))
       (gnus-group-news-low-face ((t (:foreground "yellow green"))))
       (gnus-header-name-face ((t (:foreground "DodgerBlue1"))))
       (gnus-header-newsgroups-face ((t (:italic t :foreground "LightSkyBlue3"))))
       (gnus-signature-face ((t (:foreground "salmon"))))
       (gnus-summary-cancelled-face ((t (:background "black" :foreground "yellow"))))
       (gnus-summary-high-ancient-face ((t (:foreground "RoyalBlue"))))
       (gnus-summary-high-read-face ((t (:foreground "forest green"))))
       (gnus-summary-high-ticked-face ((t (:foreground "burlywood"))))
       (gnus-summary-high-unread-face ((t (:italic t :foreground "cyan"))))
